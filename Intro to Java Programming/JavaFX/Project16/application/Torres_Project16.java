...
/*** Objective: 
 * Algorithm: Javafx
 * Description how to resolve the problem: Create the interface, Use the get token method to determine whether to use x's or o's, use the is won to
...
public class Torres_Project16 extends Application {
